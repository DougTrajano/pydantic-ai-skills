...
@pytest.mark.asyncio
async def test_read_skill_resource_unknown_skill_raises_model_retry(sample_skills_dir: Path) -> None:
...
@pytest.mark.asyncio
async def test_read_skill_resource_unknown_resource_raises_model_retry(sample_skills_dir: Path) -> None:
